...
import 'package:mandaos/modules/db/screen/backRestore_screen.dart';
...
Map<String, WidgetBuilder> getAplicationRoutes() {
  ...
  final BackRestoreScreen _copy = BackRestoreScreen();
  //final AddProductScreen _addProd = AddProductScreen();
  ...
  final routes = <String, WidgetBuilder>{
    ...
    'copy': (BuildContext context) => _copy,
   // 'addproduct': (BuildContext context) => _addProd,
